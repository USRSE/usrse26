  ...
  <details class="abstract">
    <summary class="abstract__summary">
      <h2 class="abstract__heading" id="designing-for-trust-in-ai-assisted-scientific-computing">
        ...
        <span class="abstract__people">Rajshree Deshmukh, Sheng Pang, Tanushree Subramanian, Johanna Cohoon, Sarah Poon and Dan Gunter</span>
      </h2>
    </summary>
...
In our talk, NERSC staff will share several resources that can be used by the HPC and RSE community for creating instructional videos. This includes a handbook with best practices, step-by-step guides regarding equipment, set up, and video production. We will also share best practices and resources for engaging with SMEs for instructional video production, to help the broader community adopt these practices to create effective instructional videos at their own institutions.{% endcapture %}{{ abstract_md | markdownify }}</div>
  ...
  <details class="abstract">
    <summary class="abstract__summary">
      <h2 class="abstract__heading" id="software-sustainability-toolkit-measuring-and-improving-sustainable-research-software-at-scale">
        <span class="abstract__title">Software Sustainability Toolkit: Measuring and Improving Sustainable Research Software at Scale</span>
        <span class="abstract__people">Aditi Gopalan, Dave Bunten, Adam Taylor, Susheel Varma, Gregory P. Way, and Jineta Banerjee</span>
      </h2>
    </summary>
    <div class="abstract__body">{% capture abstract_md %}Modern computational biology depends on research software, yet the practices needed to keep scientific tools reusable, reproducible, and maintainable are applied inconsistently. Evaluating these practices at scale is difficult because software sustainability spans licensing, citation, documentation, testing, contribution pathways, and long-term maintenance.

We present the Software Sustainability Toolkit (SST), a reproducible framework for measuring and improving research software sustainability. SST combines Software Gardening Almanack (SGA) repository metrics, JOSS-style criteria, software test checks, and AI-assisted sustainability reports that translate identified gaps into prioritized actions for maintainers. Together, these components provide complementary views of software readiness, reproducibility, governance, and maintainability.

We applied SST to 10,942 computational biology repositories spanning nine scientific domains, including genomics, transcriptomics, imaging, single-cell analysis, and structural biology. Many basic sustainability practices remain uncommon. Among the signals most associated with GitHub adoption were explicit licensing, machine-readable citation metadata, and JOSS-style compliance. After accounting for repository age and activity, licensing and citability remained associated with greater adoption, while much of the association with overall JOSS compliance reflected project maturity.

We also examined sustainability as a dynamic process. Fork activity generally increased around the adoption of sustainability practices, but increases in adoption also preceded the addition of many practices, suggesting that community growth and sustainability often develop together. Shared infrastructure can further reduce maintainer burden by supplying common documentation, governance, and testing practices.

Finally, SST connects measurement to intervention. AI-assisted tooling can convert assessment results into proposed repository changes for human review, allowing maintainers and contributors to act directly on sustainability findings. Together, these results position SST as infrastructure for measuring, studying, and improving research software sustainability, with SGA metrics, JOSS criteria, testing, and assisted remediation providing complementary paths toward more sustainable scientific software.{% endcapture %}{{ abstract_md | markdownify }}</div>
  </details>
  <details class="abstract">
    <summary class="abstract__summary">
...
In this talk, we discuss opportunities for AI tooling in science and engineering beyond coding support, providing a lens into the development work the US-RSE community may take on in the near future and the socio-technical circumstances driving it. Our results inform development priorities, strategies for issue mitigation, and long-term stewardship in scientific facilities and work. We anticipate our insights helping to improve the usability and stewardship of scientific software, especially for high performance data and computing work.{% endcapture %}{{ abstract_md | markdownify }}<p class="abstract__meta"><a href="https://doi.org/10.5281/zenodo.22256604">https://doi.org/10.5281/zenodo.22256604</a></p></div>
  </details>
  <details class="abstract">
    <summary class="abstract__summary">
  ...
  <details class="abstract">
    <summary class="abstract__summary">
      <h2 class="abstract__heading" id="developing-a-handbook-of-best-practices-for-research-software-sustainability-at-princeton">
        ...
        <span class="abstract__people">Tai Sakuma, Joel Bretheim, Ian Cosden, Jacob Murel, Robert Caddy, Henry Schreiner, Lucas Sawade, Rohit Kakodkar, Mohamed Abdellatif, Georgios Artavanis, Andres Rios Tascon, Rebecca Sutton Koeser, Anushka Acharya, Luca Bonaldo, Amy Defnet, Rob Bierman, Jonathan Hanke, Joshua Carmichael, Lance Parsons, and David Luet</span>
      </h2>
    </summary>
...
In the Princeton RSE group, we are developing a handbook of best practices for research software sustainability. As sustainability is inherently contingent [4], it is not possible to prescribe criteria for it. Instead, the Handbook enumerates characteristics of sustainable research software. Software with these characteristics substantially increases its chances of being sustained. Sustainable research software has reliable tests as its technical foundation; they enable iterative cycles of refactoring and feature addition and also underpin confidence in AI-assisted and agentic development, yielding frequent releases that progressively improve maintainability, reproducibility, and other technical qualities. These technical characteristics are necessary but not sufficient. Long-term sustainable research software also has social and organizational characteristics, including citability, continuous funding, professional maintenance, and active communities.

The Handbook collects best practices, based on our experience, that realize these characteristics, from basics to advanced topics such as how to turn unsustainable research code into a testable package. The Handbook facilitates communication with principal investigators and research project managers; the best practices describe what we do and how we identify and resolve software engineering issues within research projects.

In this talk, we will present our approach to building the Handbook; discuss what distinguishes it from other best practices guides, for instance, its grounding in the operational practice of a centralized, multidisciplinary RSE group; review the practices at a high level; and suggest ways for others in the community to leverage the Handbook in their organizations. The Handbook will be publicly available under a Creative Commons license. The Handbook is not a static document that we publish and finish; we develop it as we develop sustainable software, with continuous updates as demanded, most frequently by the rapid evolution of AI tools and practices.{% endcapture %}{{ abstract_md | markdownify }}<p class="abstract__meta"><a href="https://doi.org/10.5281/zenodo.22777729">https://doi.org/10.5281/zenodo.22777729</a></p></div>
  </details>
  <details class="abstract">
    <summary class="abstract__summary">
